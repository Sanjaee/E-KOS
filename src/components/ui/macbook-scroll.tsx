...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex sm:min-h-[200vh]  shrink-0 scale-[0.55] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 md:pb-80 md:pt-40 pb-96"
    >
      <motion.h2
        style={{
